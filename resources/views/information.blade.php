...
<html lang="en">
  ...
  <nav class="fixed w-full border-gray-200 bg-white dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between p-4 px-10 py-3">
    ...
    <div class="p-4">
      <div class="mt-14 rounded-lg border-2 p-4">
        <section class="container mx-auto flex h-screen flex-col bg-white">
          <div class="flex flex-col overflow-x-auto">
            <h1 class="mb-4 text-2xl font-bold">Bill Information</h1>
            <div class="overflow-x-auto rounded-lg bg-white shadow-md">
              <table class="min-w-full border-2 border-gray-200 bg-white">
                <thead class="bg-indigo-400">
                  <tr>
                    <th class="border-b border-gray-200 px-4 py-2 text-left">Data Pembayaran</th>
                  </tr>
                </thead>
                <tbody>
                  <!-- Data Pembayaran -->
                  <tr>
                    <td class="border-b border-gray-200 px-4 py-2">hvv<br>dasda<br>bebeb</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="mt-4 flex justify-end space-x-2">
            <button class="rounded bg-red-500 px-4 py-2 text-white" onclick="window.history.back();">Back</button>
            <button class="rounded bg-yellow-300 px-4 py-2 text-gray-800">Bayar</button>
          </div>
        </section>
      </div>
    </div>
    ...
    <footer class="bg-green-200">
      <div class="container mx-auto w-full max-w-screen-xl p-4 py-6">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="https://flowbite.com/" class="flex items-center">
              <img src="/assets/img/L.png" class="me-3 h-8" alt="Logo" />
              <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">-Electricz</span>
            </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
            <div>
              ...
              <ul class="font-medium text-gray-500 dark:text-gray-400">
                <li class="mb-4">
                  <a href="#" class="hover:underline">e-Electricz</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <hr class="my-6 border-gray-900 sm:mx-auto lg:my-16" />
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">© 2023 <a href="#"
              class="hover:underline">e-Electricz™</a>. All Rights Reserved.
          </span>
          <div class="mt-4 flex sm:mt-0 sm:justify-center">
            <a href="#" class="text-gray-500 hover:text-blue-500 dark:hover:text-white">
            ...
            <a href="#" class="ms-5 text-gray-500 hover:text-blue-500 dark:hover:text-white">
              <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 21 16">
                <path
