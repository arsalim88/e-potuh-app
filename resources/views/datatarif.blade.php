      ...
      <div class="mt-14 rounded-lg border-2 border-dashed border-gray-200 p-4 dark:border-gray-700">
        <section class="container mx-auto flex h-screen flex-col bg-white dark:bg-gray-900">
          <div>
            ...
            <h1 class="mb-4 text-2xl font-bold">Tariff Data</h1>
            <div class="mb-10 flex justify-end">
              <a class="rounded bg-green-400 px-3 py-1 text-white hover:bg-blue-500" href="/addtarif">
              ...
              <table class="min-w-full border border-gray-200 bg-white text-center">
                <thead class="bg-blue-300">
                  <tr>
                    ...
                    <th class="border border-gray-300 px-4 py-2">Id Tariff</th>
                    <th class="border border-gray-300 px-4 py-2">Power</th>
                    <th class="border border-gray-300 px-4 py-2">Rate /Kwh</th>
                    <th class="border border-gray-300 px-4 py-2">Edit</th>
                    <th class="border border-gray-300 px-4 py-2">Wipe</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2">
                      <button class="rounded bg-green-400 px-3 py-1 text-white hover:bg-blue-400">
                        <svg class="h-6 w-6 text-gray-200 dark:text-white" aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                          viewBox="0 0 24 24">
                          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
