      ...
      <div class="mt-14 rounded-lg border-2 p-4">
        <section class="container mx-auto flex h-screen flex-col bg-white">
          <div class="flex flex-col overflow-x-auto">
            <h1 class="mb-4 text-2xl font-bold">Tagihan Anda</h1>
            <div class="overflow-x-auto rounded-lg bg-white shadow-md">
              <table class="min-w-full border border-gray-200 bg-white">
                <thead class="bg-yellow-300">
                  <tr>
                    <th class="border-b border-gray-200 px-4 py-2 text-left">Informasi</th>
                  </tr>
                </thead>
                <tbody>
                  <!-- Data Pembayaran -->
          ...
          <div class="mt-4 flex justify-end space-x-2">
            <a class="rounded bg-red-500 px-4 py-2 text-white hover:bg-red-400" href="">Back</a>
            <button class="rounded bg-indigo-500 px-4 py-2 text-white hover:bg-green-400">Cetak Bukti</button>
          </div>
        </section>
      </div>
    </div>
