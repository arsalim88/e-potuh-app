      ...
      <div class="mt-14 rounded-lg border-2 border-dashed border-gray-200 p-4 dark:border-gray-700">
        <section class="container mx-auto flex h-screen flex-col bg-white dark:bg-gray-900">
          <div>
            ...
            <h1 class="mb-4 text-2xl font-bold">Admin Data</h1>
            <div class="mb-10 flex justify-end">
              <a class="rounded bg-indigo-500 px-3 py-1 text-white hover:bg-green-400" href=""> <svg
              ...
              <table class="min-w-full border border-gray-200 bg-white text-center">
                <thead class="bg-indigo-400">
                  <tr>
                    ...
                    <th class="border border-gray-300 px-4 py-2">Name Admin</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2">
                      <a class="inline-block rounded bg-indigo-500 px-3 py-1 text-white hover:bg-green-400"
                        href="">
                    ...
                    <td class="border border-gray-300 px-4 py-2">
                      <button class="rounded bg-indigo-500 px-3 py-1 text-white hover:bg-green-400"><svg
    ...
    <footer class="m-4 rounded-lg bg-white shadow">
      <div
        ...
        <span class="text-sm text-gray-500 sm:text-center">
          <?= date('Y') ?> <a href="#" class="hover:underline">Electric Pay™</a>. All Rights
          Reserved.
        </span>
      </div>
    </footer>
